...
dataset = load_files(container_path = "/home/caique/Documentos/Data-Science/black-fraude/tweets_txt", 
...
for n_clusters in range_n_clusters:
    ...
    file_name = "tweets_" + str(n_clusters) + "_clusters.csv"
